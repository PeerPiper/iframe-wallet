...
function setMaxDimensions() {
    iframe.contentWindow.postMessage({ msg: 'maxOffsetWidth', size: document.body.clientWidth }, origin);
    iframe.contentWindow.postMessage({ msg: 'maxOffsetHeight', size: document.body.clientHeight }, origin);
}
function syncWidth() {
