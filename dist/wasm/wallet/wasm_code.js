...
* @returns {Uint8Array}
*/
export function sign(secret_key_bytes, message) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.sign(retptr, addHeapObject(secret_key_bytes), ptr0, len0);
...
export class Proxcryptor {
    ...
    */
    generate_re_key(public_key, tag) {
        ...
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.proxcryptor_generate_re_key(this.ptr, addHeapObject(public_key), ptr0, len0);
        return takeObject(ret);
    }
    /**
...
export class SimpleKeypair {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_simplekeypair_free(ptr);
    }
    /**
    * @returns {any}
    */
    public() {
        var ret = wasm.simplekeypair_public(this.ptr);
        return takeObject(ret);
    }
    /**
    * @returns {any}
    */
    secret() {
        var ret = wasm.simplekeypair_secret(this.ptr);
        return takeObject(ret);
    }
}
